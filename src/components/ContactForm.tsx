...
const ContactForm = () => {
  ...
  return (
    ...
    {/* Contact Information Card (1st Column) */}
    <div className="space-y-6"> {/* You can remove this outer div if it's just the card inside */}
    ...
    {/* Map Card (2nd Column) */}
    <div> {/* This div acts as the second column in the grid */}
